...
class CustomerService(ICustomerService):
    ...
    def register_customer(self):
        ...
        conn = get_connection()
        cursor = conn.cursor()
        insert_query = 'INSERT INTO Customers(FirstName, LastName, Email, PhoneNumber, Address, Username, Password, RegistrationDate) VALUES (?, ?, ?, ?, ?, ?, ?, ?)'
        try:
    ...
    def update_customer(self):
        ...
        update_query = 'UPDATE Customers SET FirstName = ?, LastName = ?, Email = ?, PhoneNumber = ?, Address = ? WHERE customer_id = ?'
        try:
            cursor.execute(update_query, (
                customer.get_first_name(), customer.get_last_name(), customer.get_email(),
                customer.get_phone_number(), customer.get_address(), customer_id
            ))
            conn.commit()
    ...
    def delete_customer(self):
        ...
        cursor = conn.cursor()
        try:
            select_query = "SELECT * FROM Customers WHERE customer_id = ?"
